...
if($_SERVER['REQUEST_METHOD']=='POST') {
		if( isset($_POST['Pid']) and isset($_POST['email']) and isset($_POST['Password']) and isset($_POST['Name']) and isset($_POST['Sex']) and
			...
			$db = new DbOperations();
                  $result = $db->createUser(
                              $_POST['Pid'], $_POST['email'], $_POST['Password'], $_POST['Name'], $_POST['Sex'], $_POST['DOB'],
